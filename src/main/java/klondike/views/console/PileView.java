...
public class PileView {
    ...
    public void writeln() {
        ...
        IO.write(this.index + ": ");
        if (cards.empty()) {
            IO.write(Message.EMPTY.getMessage());
        } else {
            writelnCard(cards,numberOfFaceUpCards,numberOfFaceDownCards);
        }
        IO.writeln();
    }

    public void writelnCard(Stack<Card> cards, int numberOfFaceUpCards, int numberOfFaceDownCards){
